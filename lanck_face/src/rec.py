...
import numpy as np
from src.util import getPaddingSize
from network.cnn import NUMBER_OUTPUT

CSV_TRAIN_PATH = "../CSV/iris_training.csv"
CSV_TEST_PATH = "../CSV/iris_test.csv"
    ...
    with open(PATH, "r") as csvs:
        ...
        for rows in list(reader):
            ...
            try:
                ...
                # image_data = getPaddingSize(image_data, 64, 64)
                image_data = image_data[:, :, ::-1]  # problem
