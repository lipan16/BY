...
def facedetect(windowname, camera_id): # 命名和打开摄像头
    cv2.namedWindow(windowname)
    cap = cv2.VideoCapture(camera_id)


    # 加载分类器
    classfier = cv2.CascadeClassifier('D:\Program Files\opencv\sources\data\haarcascades\haarcascade_frontalface_alt2.xml')
