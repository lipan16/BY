...
def get_model(weights_file=None):
    ...
    x6 = Dense(CLASS_NUM, activation='softmax', name="Sixth")(x)

    models = Model(inputs=inputs, outputs=[x1, x2, x3, x4, x5, x6])
...
def get_picture(save_path="/picture/6_number_network.png"):
